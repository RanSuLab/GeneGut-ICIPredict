...
The following files are provided via Zenodo:  
Fengyun, Z. (2026). *Dataset for BioP-VAE project* [Data set]. Zenodo. https://doi.org/10.5072/zenodo.467299


| File | Description |
|-----|-----|
| `CA209-538-200contig_ReferenceGenome_RPKM_Features_CA209-538.csv` | RPKM feature matrix for the **Ashray_2024** cohort. |
| `CA209-538-200contig_ReferenceGenome_RPKM_Features_PRJEB43119.csv` | RPKM feature matrix for the **Lee_2022** dataset. |
| `CA209-538-200contig_ReferenceGenome_RPKM_Features_PRJNA397906.csv` | RPKM feature matrix for the **Frankel_2017** dataset. |
| `CA209-538-200contig_ReferenceGenome_RPKM_Features_PRJNA3997426.csv` | RPKM feature matrix for the **Matson_2018** dataset. |
| `CA209-538_embedding.pth` | Protein embedding prior file. |
| `mutual_info_results.npz` | Mutual information results of  **Ashray_2024** cohort. |



After downloading the dataset, place the files into the `../dataset/RPKM` directory of this repository.
...
```python
label_file1 = "../dataset/label/PRJEB43119_label.csv"
RPKM_features1 = "../dataset/RPKM/CA209-538-200contig_ReferenceGenome_RPKM_Features_PRJEB43119.csv"
...
--RPKM_features ../dataset/RPKM/CA209-538-200contig_ReferenceGenome_RPKM_Features_CA209-538.csv \
--label_file ../dataset/label/CA209-538_label.csv \
--prior_file_path ../dataset/RPKM/CA209-538_embedding.pth \
--task BOR \
--cuda_device 3 \
--epochs 500 \
...
--RPKM_features ../dataset/RPKM/CA209-538-200contig_ReferenceGenome_RPKM_Features_PRJNA397906.csv \
--label_file ../dataset/label/PRJNA397906_label.csv \
--prior_file_path ../dataset/RPKM/CA209-538_embedding.pth \
--cuda_device 8 \
--mutual_info_dir ../dataset/RPKM \
--task BOR \
--is_use_mutual_info 1 \
